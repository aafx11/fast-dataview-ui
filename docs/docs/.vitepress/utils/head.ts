...
export const head: HeadConfig[] = [
  ...
  [
    ...
    {
      property: 'og:title',
      content: 'fast-dataview-ui 可在 vue3 应用程序中快速构建交互界面，看起来还不错。'
    }
  ],
  /**
   * OG 类型
  ...
  [
    'meta',
    {
      ...
      content:
        'fast-dataview-ui 可在 vue3 应用程序中快速构建交互界面，看起来还不错。 fast-dataview-ui 是一款灵活、优质的组件库，为开发者、设计师准备。希望开发者可以借用其中的设计，在不久的将来，孕育出更高阶的组件库。'
    }
  ],
  /**
   * OG 页面所在网站名
